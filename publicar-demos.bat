...
git add -A
git commit -m "Atualizacao demos nutricionistas Sinop" >nul 2>nul
...
echo.
echo ============================================================
echo    [FALHOU] O envio NAO foi concluido.
echo    Verifique:
...
echo.
echo    Agora escreva  "subi"  para o Claude verificar.
echo ============================================================
echo.
...
echo   Leia a mensagem acima e aperte qualquer tecla para sair.
echo  --------------------------------------------------------
pause >nul
